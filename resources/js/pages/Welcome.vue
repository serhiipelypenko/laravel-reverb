...
/*const { listen } = useEcho('hello-world')   // ← add "public-"

listen('HelloWorld', (e) => {
    console.log('🎉 Public channel works!', e)
    alert(e.message)
})*/


const { listen, stopListening, leaveChannel } = useEcho('hello-world')

onMounted(() => {
    console.log(333);
    listen('HelloWorld', (event: any) => {
        console.log('🎉 Hello from Reverb!', event)
        alert('Message: ' + event.message)
    })
})

onUnmounted(() => {
    stopListening('HelloWorld')   // optional - clean up specific listener
    leaveChannel()                // optional - leave channel completely
})
